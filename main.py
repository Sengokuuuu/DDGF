...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--simplified",
        action="store_true",
        help="Use simplified DDGF, without SVD",
    )    
    parser.add_argument(
        "-i",
        "--image_folder",
    ...
    parser.add_argument(
        "--lambda_prior", type=float, default=0.1, help="Weight for gradient prior regularization"
    )
    parser.add_argument(
        "--alpha_prior", type=float, default=0.5, help="Fractional order for gradient prior (0 < alpha <=1)"
    )
    parser.add_argument(
        "--omega_prior", type=float, default=0.5, help="Cutoff frequency for frequency prior (0 < omega <=1)"
    )
